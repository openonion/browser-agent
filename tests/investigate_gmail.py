"""
Investigation of Gmail's DOM structure and scroll methods.
Findings informed scroll.py AI strategy: container scrolling (overflow:auto) is correct for Gmail.
"""
